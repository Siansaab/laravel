...
<head>
  ...
  <!-- plugins:dashboard/css -->
  <link rel="stylesheet" href="dashboard/vendors/feather/feather.css">
  <link rel="stylesheet" href="dashboard/vendors/ti-icons/css/themify-icons.css">
  <link rel="stylesheet" href="dashboard/vendors/css/vendor.bundle.base.css">
  <!-- endinject -->
  <!-- Plugin dashboard/css for this page -->
  <link rel="stylesheet" href="dashboard/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
  <link rel="stylesheet" href="dashboard/vendors/ti-icons/css/themify-icons.css">
  <link rel="stylesheet" type="text/dashboard/css" href="dashboard/js/select.dataTables.min.css">
  <!-- End plugin dashboard/css for this page -->
        ...
        <div class="tab-content" id="setting-content">
          <div class="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
            ...
            <div class="events pt-4 px-3">
              ...
              <p class="mb-0 font-weight-thin text-gray">Creating component page build a dashboard/js</p>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ URL::to('/adminproduct')}}">View All</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ URL::to('/cart')}}">Cart</a></li>
              </ul>
            </div>
          </li>
